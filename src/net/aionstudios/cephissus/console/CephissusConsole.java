 ...
 */
public class CephissusConsole {
	
	private static CephissusConsole self;
	...
	private CephissusConsole() {
		...
		consoleThread.setName("CephissusPrimary-Console");
	}
	 ...
	 */
	public static CephissusConsole getInstance() {
		if(self==null) {
			self = new CephissusConsole();
		}
		return self;
	}
